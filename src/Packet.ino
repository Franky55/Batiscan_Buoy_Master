...
#define DIV_COUNTING "Packet.ino: DIV_COUNTING"
#define INTERNAL_BUFFER_SIZE_ERROR "Packet.ino: INTERNA_BUFFER_SIZE_ERROR"
#define INTERNAL_CHUNK_CONVERTION_FAIL "Packet.ino: INTERNAL_CHUNK_CONVERTION_FAIL"
...
Execution cPacket::FullyAnalyze(unsigned short* packetToAnalyze, int* resultedPacketsize, int* amountOfParameters, unsigned char* packetID)
{
    ...
    if(execution != Execution::Passed)
    {
        Device.SetErrorMessage("553:Packet -> Chunk.ToType    ");
        return Execution::Crashed;
    }
